import { ApiResponse, Promotion, FactPenjualan, GrossProfitResponse, GrossMarginResponse, JumlahStokResponse, Produk, Snapshot, AccumulativeSnapshot, Store, FactlessResponse, Date } from "@/model/Dimension"
